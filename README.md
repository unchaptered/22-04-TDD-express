...
22-04-TDD-express 는 Jest 를 이용한 TDD 를 연습하기 위한 레포입니다.

## Purpose

- [✅] Jest 를 이용한 유닛 테스트 작성 연습
- [❌] 서버의 반환 객체의 일관성 유지 연습 > [unchaptered/22-04-TDD-express-2](https://github.com/unchaptered/22-04-TDD-express-2) 에서 진행
